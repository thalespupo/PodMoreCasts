 ...
 * so that {@link PlayerTestActivity} can control music playback.
 */
public final class MediaPlayerAdapter extends PlayerAdapter {
     ...
     * created. In the onStop() method of the {@link PlayerTestActivity} the {@link MediaPlayer} is
     * released. Then in the onStart() of the {@link PlayerTestActivity} a new {@link MediaPlayer}
    ...
    @Override
    public void playFromEpisode(Episode episode) {
        mCurrentEpisode = episode;
        playFile(episode.getPathInDisk());
    }
    ...
    private void playFile(String filename) {
        ...
        if (fd == null) {
            throw new NullPointerException("fd media is null for " + mFilename);
        }
